...
The purpose of this application is to show a demo of graphite grafana integration with the metrics that are emiited from a spring boot application

## What's inside

The repo is a working application with a minimal setup. It contains:
